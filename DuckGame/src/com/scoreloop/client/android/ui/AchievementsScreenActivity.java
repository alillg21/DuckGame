...
/**
 * This activity shows the awards of the game and whether the game player has achieved any of them.
 * Awards which have been achieved, are clickable thereby opening a dialog that enables the user to 
 * post the achievement to a social network.
 * 
 * Only available, when the ui.feature.achievement property in scoreloop.properties is set to <code>true</code>.
 * 
