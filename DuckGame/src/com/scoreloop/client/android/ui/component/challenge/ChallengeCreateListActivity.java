...
public class ChallengeCreateListActivity extends ChallengeActionListActivity implements ChallengeControllerObserver, OnActionListener, OnControlObserver {
	...
	ChallengeParticipantsListItem getChallengeParticipantsListItem() {
		if (_challengeParticipantsListItem == null) {
			final String contenderName = getUser().getDisplayName();
			final String contestantName = _contestant != null ? _contestant.getDisplayName() : getResources().getString(R.string.sl_anyone);
