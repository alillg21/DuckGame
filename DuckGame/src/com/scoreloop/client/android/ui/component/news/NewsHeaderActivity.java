...
public class NewsHeaderActivity extends ComponentHeaderActivity {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		getImageView().setImageDrawable(StringFormatter.getNewsDrawable(this, getContentValues(), true));

		addObservedContentKeys(Constant.NEWS_NUMBER_UNREAD_ITEMS);
	}

	@Override
	public void onValueChanged(final ValueStore valueStore, final String key, final Object oldValue, final Object newValue) {
		setSubTitle(StringFormatter.getNewsSubTitle(this, getContentValues()));
		getImageView().setImageDrawable(StringFormatter.getNewsDrawable(this, getContentValues(), true));
	}
