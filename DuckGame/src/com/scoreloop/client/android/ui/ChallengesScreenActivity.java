...
/**
 * This activity presents a user interface for listing and starting game challenges. It lists open and
 * finished challenges and enables the game player to challenge a buddy or an anonymous user.
 * 
 * Only available, when the ui.feature.challenge property in scoreloop.properties is set to <code>true</code>.
 * 
 * When supporting challenges, you have to follow the lifecycle as explained in ScoreloopManager.
 * 
