...
public abstract class ComponentHeaderActivity extends ComponentActivity implements OnClickListener {
	...
	protected void setCaption(final String captionText) {
		if (_caption == null) {
			final ViewGroup captionContainer = (ViewGroup) findViewById(R.id.sl_caption_container);
			if (captionContainer != null) {
				final LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
				_caption = (TextView) inflater.inflate(R.layout.sl_header_caption, null);
				captionContainer.addView(_caption);
			}
		}
		if (_caption != null) {
